...
> **подтверждающее искажение** — свойство человека искать, интерпретировать, предпочитать и запоминать информацию так, что она <b>подтверждает</b> его предшествующие убеждения и гипотезы.
